...
using MotoVernal.Authorizations.Handlers;
...
internal class Program
{
    ...
    private static async Task SeedRolesAndAdminUser(IServiceProvider serviceProvider)
    {
        ...
        var adminUser = await userManager.FindByEmailAsync("admin@MotoVernal.com");
        if (adminUser == null)
        {
            var newAdmin = new User("admin", "admin@MotoVernal.com", null, null, DateTime.Now, "")
            {
                EmailConfirmed = true
            };
