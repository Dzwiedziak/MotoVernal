const fileUpload = document.querySelector('.photo-select__file');
const base64Input = document.querySelector('.base64');
...
const loadImageLabel = document.querySelector('.load-image-label');
